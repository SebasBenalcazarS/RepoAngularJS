...
public interface IAdministracionGuiasServicio {
...
//	public <T extends SearchDTO> Duplex<T, SearchResultDTO<T>> obtenerGuiasPorPlantillas(Integer codigoCompania,	Collection<ISearchTemplate> plantillasBusqueda,	Boolean datosPaginados, Integer firstResult, Integer maxResults, Boolean paginadoManual, String codigoFuncionario) throws SICException;
	 ...
	 * @throws SICException
	 */
//	public void transGuardarPreGuia(GuiaTransporteDTO guiaTransporteDTO, Collection<GuiaTransporteDestinoDTO> guiaTransporteDestinoCols, Collection<GuiaTransporteDocumentoDTO> guiaTransporteDocumentoCols) throws SICException;
	 ...
	 * @throws SICException
	 */
//	public GuiaTransporteDTO transCrearGuiaRemision(GuiaTransporteDTO guiaTransporteDTO) throws SICException;
