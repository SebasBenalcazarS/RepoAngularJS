...
/**
 * Tabla para guadar la fecha y hora de llegada para realizar la recepcion de la mercaderia del proveeedor
 * 
 * @author acaiza
 * @author guvidia
 */
@SuppressWarnings("serial")
@Table(name = "SBLOGTENTRECPRO")
public class EntregaRecepcionProveedorDTO extends SimpleAuditDTO {
	 ...
	 */
	@EmbeddedId
	private ec.com.smx.sic.cliente.mdl.dto.id.EntregaRecepcionProveedorID id = new ec.com.smx.sic.cliente.mdl.dto.id.EntregaRecepcionProveedorID();
	 ...
	 * @return the id
	 */
	public ec.com.smx.sic.cliente.mdl.dto.id.EntregaRecepcionProveedorID getId() {
		return id;
	}
	 ...
	 */
	public void setId(
			ec.com.smx.sic.cliente.mdl.dto.id.EntregaRecepcionProveedorID id) {
		this.id = id;
	}

	public Boolean getTieneEntregaDTO() {
		return isLoaded(this.entregaDTO);
	}
