...
/**
 * Clase que encapsula a las propiedades Identificadoras de la clase ProveedorNegociacion
 * @see ec.com.smx.sic.adm.dto.ProveedorNegociacion
 *
 * @author kruger
 */
@Embeddable
public class ProveedorNegociacionID implements Serializable {
