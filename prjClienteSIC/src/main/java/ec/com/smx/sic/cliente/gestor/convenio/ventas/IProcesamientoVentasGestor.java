 ...
 * @author egudino 
 */
public interface IProcesamientoVentasGestor {
	 ...
	 * @param registroConbroDTO
	 */
	void registrarConbroParticipacion(Collection<RegistroCobroDTO> registroConbroDTOCols ,VistaProcesamientoVentasDTO vistaProcesamientoDTO, Integer codigoCompania, String userId);
	 ...
	 * @param userId
	 */
	void registrarCobroDiarioProyectado(Collection<RegistroCobroDiarioDTO> registroConbroDTOCols ,VistaProcesamientoVentasDTO vistaProcesamientoDTO, Integer codigoCompania, String userId);
