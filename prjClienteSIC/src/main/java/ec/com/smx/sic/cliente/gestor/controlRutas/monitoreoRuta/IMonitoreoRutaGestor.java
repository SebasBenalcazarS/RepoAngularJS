package ec.com.smx.sic.cliente.gestor.controlRutas.monitoreoRuta;
...
public interface IMonitoreoRutaGestor {
...
//	public Collection<RutaDestinoDTO> obtenerListaDestinosRuta(Integer codigoCompania, Long codigoRuta) throws SICException;
	 ...
	 * @throws SICException
	 */
//	public void guardarNovedadesBitacora(Collection<RutaBitacoraNovedadDTO> novedadesCols, String userId, Integer codigoCompania)throws SICException;
