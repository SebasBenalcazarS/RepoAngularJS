...
import ec.com.smx.sic.cliente.mdl.dto.id.RegistroCobroID;
...
@Entity
@Table(name = "SCCEMTREGCOB")

public class RegistroCobroDTO implements Serializable{
	@EmbeddedId
	private RegistroCobroID id=new RegistroCobroID();
	...
	/**
	 * Valor relacionado del la tabla fechas cobro
	 */
	@Column(name="CODIGOPLANFECHAREGISTROCOBRO")
	...
	/**
	 * Obtiene la relacion con plan fecha registro cobro
	 * 
	 */
	@ManyToOne(fetch = LAZY)
	@JoinColumns({ @JoinColumn(name = "CODIGOCOMPANIA", referencedColumnName = "CODIGOCOMPANIA", insertable = false, updatable = false), 
	@JoinColumn(name = "CODIGOPLANFECHAREGISTROCOBRO", insertable = false, updatable = false, referencedColumnName = "CODIGOPLANFECHAREGISTROCOBRO") })
	private PlanFechaRegistroCobroDTO planFechaRegistroCobroDTO;
	...
	private Collection<RegistroCobroDetalleDTO> registroCobroDetalleCol;
	 ...
	 */
	public void setId(RegistroCobroID id) {
		this.id = id;
	}
	 ...
	 */
	public Collection<RegistroCobroDetalleDTO> getRegistroCobroDetalleCol() {
	 ...
	 */
	public void setRegistroCobroDetalleCol(Collection<RegistroCobroDetalleDTO> registroCobroDetalleCol) {
	...
	/**
	 * @return the planFechaRegistroCobroDTO
	 */
	public PlanFechaRegistroCobroDTO getPlanFechaRegistroCobroDTO() {
		return planFechaRegistroCobroDTO;
	}

	/**
	 * @param planFechaRegistroCobroDTO the planFechaRegistroCobroDTO to set
	 */
	public void setPlanFechaRegistroCobroDTO(PlanFechaRegistroCobroDTO planFechaRegistroCobroDTO) {
		this.planFechaRegistroCobroDTO = planFechaRegistroCobroDTO;
	}
