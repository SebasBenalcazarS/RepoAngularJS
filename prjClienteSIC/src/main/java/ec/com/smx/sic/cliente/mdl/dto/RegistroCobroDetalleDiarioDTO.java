...
import ec.com.smx.sic.cliente.mdl.dto.id.RegistroCobroDetalleDiarioID;
...
@Entity
@Table(name = "SCCEMTREGCOBDETDIA")
public class RegistroCobroDetalleDiarioDTO {
	
	@EmbeddedId
	private RegistroCobroDetalleDiarioID id=new RegistroCobroDetalleDiarioID();
	...
	private RegistroCobroDiarioDTO registroCobroDTO;
	 ...
	 */
	public RegistroCobroDetalleDiarioID getId() {
		return id;
	}
	 ...
	 */
	public void setId(RegistroCobroDetalleDiarioID id) {
		this.id = id;
	}
	 ...
	 */
	public RegistroCobroDiarioDTO getRegistroCobroDTO() {
	 ...
	 */
	public void setRegistroCobroDTO(RegistroCobroDiarioDTO registroCobroDTO) {
