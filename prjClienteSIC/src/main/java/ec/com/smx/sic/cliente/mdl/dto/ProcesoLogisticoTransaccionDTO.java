...
import ec.com.smx.sic.cliente.mdl.dto.id.ProcesoLogisticoTransaccionID;
...
@Entity
@Table(name="SBLOGTPROLOGTRA")
public class ProcesoLogisticoTransaccionDTO  extends SimpleAuditDTO{
	
	/**
	 * Clave primaria de la tabla procesologistico transaccion
	 * 
	 */
	@EmbeddedId
	private ProcesoLogisticoTransaccionID id = new ProcesoLogisticoTransaccionID();
	...
	/**
	 * Referencia con la tabla tipo transaccion
	 * 
	 */
	@ManyToOne(fetch = FetchType.LAZY)
	@JoinColumns({
		@JoinColumn(name="CODIGOCOMPANIA", referencedColumnName="CODIGOCOMPANIA", insertable=false, updatable=false),
		@JoinColumn(name="CODIGOTRANSACCION", referencedColumnName="CODIGOTIPOTRANSACCION", insertable=false, updatable=false)})
	private TransaccionDTO transaccionDTO;
	
	/**
	 * @return the id
	 */
	public ProcesoLogisticoTransaccionID getId() {
		return id;
	}
	 ...
	 */
	public void setId(ProcesoLogisticoTransaccionID id) {
		this.id = id;
	}
