...
public interface IArticuloSolicitudImpresionEtiquetasServicio {
	...
	/**
	 * Metodo que retorna los articulos encontrados segun los filtros dde busqueta utilizados
	 ...
	 * @throws SICException
	 */
	Collection<EstructuraArticuloProveedorSolImpresion> buscarArticuloProveedorPorIdArticulo(ArticuloID articulioID)throws SICException;
}
