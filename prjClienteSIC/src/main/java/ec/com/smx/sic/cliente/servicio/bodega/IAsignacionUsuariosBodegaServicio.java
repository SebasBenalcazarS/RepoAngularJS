...
public interface IAsignacionUsuariosBodegaServicio {
	...
	/**
	 * 
	 * @param vistaAsignacionUsuariosVO
	 * @return
	 * @throws SICException
	 */
	VistaAsignacionUsuariosVO obtenerVistaAsignacionUsuariosPaginado(VistaAsignacionUsuariosVO vistaAsignacionUsuariosVO) throws SICException;
	 ...
	 * @throws SICException
	 */
	HashMap<Integer, Collection<DetalleConfiguracionProcesoPerfilDTO>> obtenerConfiguraciones (Integer codigoCompania, Collection<String> codigoPerfil) throws SICException;
	 ...
	 * @throws SICException
	 */
	void transAsignacionFuncionarioProcesoPerfil(Integer codigoCompania, String userId, String codigoFuncionario, DetalleConfiguracionProcesoPerfilDTO detalleConfiguracionProcesoPerfilDTO) throws SICException;
