...
/**
 * Clase que encapsula a las propiedades Identificadoras de la clase Tarea y DatosTarea
 * 
 * @see ec.com.smx.sic.cliente.mdl.dto.TareaDatosTareaDTO
 * 
 * @author kruger
 */
@SuppressWarnings("serial")
@Embeddable
public class TareaDatosTareaID implements Serializable {
	...
	/**
	 * Secuencial de la tabla TareaDatosTarea
	 * 
	 */
	@Column(name = "CODIGOTAREADATOSTAREA", nullable = false)
	@SequenceDataBaseValue(descriptorClass = DescriptorSecuenciasSIC.class, 
						   name = "SBLOGSECTARDATTAR", 
	...
	private java.lang.Long codigoTareaDatosTarea;
	 ...
	 */
	public java.lang.Long getCodigoTareaDatosTarea() {
	 ...
	 */
	public void setCodigoTareaDatosTarea(java.lang.Long codigoTareaDatosTarea) {
