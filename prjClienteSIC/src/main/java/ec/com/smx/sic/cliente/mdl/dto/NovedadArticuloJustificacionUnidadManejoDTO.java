...
import ec.com.smx.sic.cliente.mdl.dto.id.NovedadArticuloJustificacionUnidadManejoID;
...
@Entity
@Table(name="SBLOGTNOVARTJUSUNIMAN")
public class NovedadArticuloJustificacionUnidadManejoDTO extends SimpleAuditDTO{
	
	@EmbeddedId
	NovedadArticuloJustificacionUnidadManejoID id = new NovedadArticuloJustificacionUnidadManejoID();
	...
	*/
	...
	/**
	 * Referencia con la tabla unidad de manejo
	 */
	 ...
	 * @return the id
	 */
	public NovedadArticuloJustificacionUnidadManejoID getId() {
		return id;
	}
	 ...
	 */
	public void setId(NovedadArticuloJustificacionUnidadManejoID id) {
		this.id = id;
	}
