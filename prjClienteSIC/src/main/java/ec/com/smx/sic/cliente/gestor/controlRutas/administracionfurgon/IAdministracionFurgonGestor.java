package ec.com.smx.sic.cliente.gestor.controlRutas.administracionfurgon;
...
public interface IAdministracionFurgonGestor {
	 ...
	 * @throws SICException
	 */
	public void guardarFurgon(FurgonDTO plantillaFurgonDTO, VehiculoFurgonDTO plantillaVehiculoFurgonDTO, FurgonAreaTrabajoDTO plantillaFurgonAreaTrabajoDTO, String tipoFurgon) throws SICException;
	 ...
	 * @throws SICException
	 */
	public void actualizarFurgon(FurgonDTO plantillaFurgonDTO, VehiculoFurgonDTO plantillaVehiculoFurgonDTO, FurgonAreaTrabajoDTO plantillaFurgonAreaTrabajoDTO, String tipoFurgon) throws SICException;
	 ...
	 * @throws SICException
	 */
	public Collection<FurgonAreaTrabajoDTO> listaFurgonPorAreaTrabajo(Integer codigoAreaTrabajo, Integer codigoCompania) throws SICException;
	 ...
	 * @throws SICException
	 */
	public void guardarParametrizacionDistancias(Integer codigoOrigen, Collection<ParametrizacionDistanciaDTO> listaDistancias, Collection<ParametrizacionDistanciaDTO> listaEliminar, String userId) throws SICException;
	 ...
	 * @throws SICException
	 */
	<T extends SearchDTO> Collection<ParametrizacionDistanciaDTO> obtenerParametrizacion(Integer codigoCompania, List<ISearchTemplate> plantillasBusqueda) throws SICException;
