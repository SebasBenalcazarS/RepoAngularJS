 ...
 * 2014-11-29
 */
public interface IConfiguracionDatosProcesadosDAO {
	 ...
	 * @param userId
	 */
	void registrarConfiguracionDatosProcesados(ConfiguracionDatosProcesadosDTO configuracionDatosProcesadosDTO, Integer companyId, String userId);
